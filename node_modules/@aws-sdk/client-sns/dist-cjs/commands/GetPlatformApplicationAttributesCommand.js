...
class GetPlatformApplicationAttributesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, GetPlatformApplicationAttributesCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_query_1.se_GetPlatformApplicationAttributesCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_query_1.de_GetPlatformApplicationAttributesCommand)(output, context);
    }
}
